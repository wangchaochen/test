...
public class Base64 {
  ...
  public static void main(String[] args) {
    String needde = "VkxNUzEyMw==";
    String needen1 = "VLMS";
    String needen2 = "VLMS123";
    System.out.println(new String(encode(needen1.getBytes())));
    System.out.println(new String(encode(needen2.getBytes())));
    System.out.println(new String(decode(needde.getBytes())));
  }
}
