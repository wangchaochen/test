...
public class SvcdUserMobileRestClientDemo {
  ...
  public SvcdUserMobileRestClientDemo() {
  ...
  public SvcdUserMobileRestClientDemo(String env) {
    this.tokenUrl = "http://auth-center.testapps.ocp.csvw.com/oauth/token";
    if ("dev".equalsIgnoreCase(env)) {
      this.dataUrl = "http://svcd-zuul.devapps.ocp.csvw.com/mobile-service/cmit/mobile";
    } else if ("test".equalsIgnoreCase(env)) {
      this.dataUrl = "http://svcd-zuul.testapps.ocp.csvw.com/mobile-service/cmit/mobile";
    } else {
      this.dataUrl = "http://svcd-zuul-prod.testapps.ocp.csvw.com/mobile-service/cmit/mobile";
    } 
    this.accountNo = "f5admin";
  ...
  public SvcdUserMobileRestClientDemo(String tokenUrl, String dataUrl, String accountNo, String accountPwd) {
  ...
  public String getAccessToken(String userName, String password) {
    ...
    try {
      ...
      Logger.getLogger(SvcdUserMobileRestClientDemo.class).info(res);
      ...
      Logger.getLogger(SvcdUserMobileRestClientDemo.class).error(e);
    } catch (IOException e) {
      Logger.getLogger(SvcdUserMobileRestClientDemo.class).error(e);
    } finally {
      if (client != null)
  ...
  public static void main(String[] args) {
    SvcdUserMobileRestClientDemo client = new SvcdUserMobileRestClientDemo("pro");
    String token = client.getAccessToken("svcd", "111111");
    System.out.println(client.getUserMobile(token, null, "13378", null));
  }
}
